...
extension URLSession {
	...
	static var cacheVideo = NSCache<NSString, VideoCache>()
	...
	func downloadImageAndCache(url: URL?, completion: @escaping (_ image: UIImage?) -> Void) {
		...
		if let cache = self.getCacheIMG(url: url) {
...
//	func downloadVideoAndCache(url: URL?, completion: @escaping (_ image: UIImage?) -> Void) {
//		guard let url = url else {
//			completion(nil)
//			return
//		}
...
//	}
//
//	func getCacheVideo(url: URL?) -> ImageCache? {
//		if let url = url  {
//			return Self.cacheIMG.object(forKey: url.absoluteString as NSString)
//		}
//
...
//	}
//
//	func setCacheVideo(_ image: UIImage, url: URL?) {
//		if let url = url  {
//			let cacheImage = ImageCache()
//			cacheImage.image = image
//
