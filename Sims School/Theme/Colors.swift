...
@frozen public struct CustomColor {
	static let inputColor: UIColor = UIColor.init(cgColor: #colorLiteral(red: 0.6000000238, green: 0.6000000238, blue: 0.6000000238, alpha: 1));
	static let borderInputColor: UIColor = UIColor.init(cgColor: #colorLiteral(red: 0.8784313725, green: 0.8784313725, blue: 0.8784313725, alpha: 1))
